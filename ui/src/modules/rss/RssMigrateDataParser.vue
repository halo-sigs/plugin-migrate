...
<template>
  ...
  >
    <template #description>
      <ol>
        <li>1. 准备 RSS 订阅源文件（XML）或可直接访问的 RSS 订阅链接</li>
        <li>2. 确认 RSS 中包含文章标题以及 content:encoded 或完整 description 内容</li>
        <li>3. 点击下方的选择 XML 文件按钮，或在下方输入 RSS 订阅链接并解析</li>
    ...
    <template #extra-selectors>
      <span class=":uno: my-2 block text-sm text-gray-500">或输入 RSS 订阅链接</span>
      <div>
